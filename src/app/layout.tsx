...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Sam Lee | Office Furniture Design",
    description: "30 years of office furniture design, project management & photography."
  },
      ...
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "30 years of office furniture design - panel products, ergonomic chairs, height adjustable desks, acoustic partitions.",
            url: baseUrl,
            sameAs: [
