    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0f0f0f] via-[#1a1a1a] to-[#0a0a0a]">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <div className="mb-6 reveal revealed reveal revealeded flex justify-center">
          ...
          <div className="inline-block px-4 py-1.5 mb-6 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-white/50 text-[11px] font-medium tracking-[0.2em] uppercase reveal revealed reveal revealeded">{t("hero.badge")}</div>
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white leading-tight tracking-tight mb-6 reveal revealed reveal revealeded">Sam Lee</h1>
          <p className="text-lg md:text-xl text-white/40 max-w-lg mx-auto mb-3 leading-relaxed font-light tracking-wide min-h-[2rem] reveal revealed reveal revealeded">{typed}{cursor&&<span className="typewriter-cursor"/>}</p>
          ...
          <div className="flex flex-wrap gap-3 justify-center reveal revealed reveal revealeded">
          ...
          <div className="mt-20 reveal revealed reveal revealeded"><p className="text-white/20 text-xs uppercase tracking-[0.3em]">{t("scroll")}</p></div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white dark:bg-[#111]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 reveal revealed">{featured.map((p:any)=>
      ...
      <section className="py-24 bg-[#f5f5f0] dark:bg-[#1a1a1a]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-5 gap-10 items-start reveal revealed">
      ...
      <section className="py-24 bg-white dark:bg-[#111]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 reveal revealed">{cases.map((c:any)=>
